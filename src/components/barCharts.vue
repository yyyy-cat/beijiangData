<template>
  <div class="charts">
    <div class="but" v-if="type == 2">
      <button
        class="shui"
        @click="toShui('标准总用量自来水用量', '总用量自来水用量', 'zylzlstonwm', '#52FBC2', 'bzwmzls', '#E1BB02')"
      >水</button>
      <button
        class="shui"
        @click="toShui('标准总用量蒸汽用量', '总用量蒸汽用量', 'zylzqtonwm','#00A8FF', 'bzwmzq','#FF9500')"
      >蒸汽</button>
      <button
        class="shui"
        @click="toShui('标准总用量天然气用量', '总用量天然气用量', 'zyltrqmwm','#01FF0E', 'bzwmtrq','#00E9FE')"
      >天然气</button>
    </div>
