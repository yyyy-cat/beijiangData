<template>
  <div class="charts">
    <div class="but" v-if="type == 2">
      <button
        class="shui"
        @click="toShui('标准自来水用量', '自来水用量', 'zylzlstonwm', '#DC143C', 'bzwmzls', '#32CD32','red')"
      >水</button>
      <button
        class="shui"
        @click="toShui('标准蒸汽用量', '蒸汽用量', 'zylzqtonwm','#DC143C', 'bzwmzq','#32CD32','red')"
      >蒸汽</button>
      <button
        class="shui"
        @click="toShui('标准天然气用量', '天然气用量', 'zyltrqmwm','#DC143C', 'bzwmtrq','#32CD32','red')"
      >天然气</button>
    </div>
