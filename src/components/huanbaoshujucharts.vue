    ...
    <div class="left">
      <div class="main">
        <div class="charts-main" :style="{ height: '900px'}">
          <div
            id="list"
            :style="{width: '6731px', height: '900px', margin: '0 auto', zIndex: '10'}"
          ></div>
        </div>
      ...
      <div class="ybp">
        <div
          id="gauge"
          :style="{width: '2000px', height: '1000px', margin: '0 auto', zIndex: '10', left: '150px',padingTop: '20px'}"
        ></div>
        <div
          id="cod"
          :style="{width: '2000px', height: '1000px', margin: '0 auto', zIndex: '10', left: '150px'}"
        ></div>
        <div
          id="lhw"
          :style="{width: '2000px', height: '1000px', margin: '0 auto', zIndex: '10', left: '150px'}"
