 ...
 components: { foot , login},
  ...
  methods: {
    xuanran(over, lineID){
      ...
      // console.log(usp);
      axios
        .post("http://125.89.236.222:8006/getRunningBasicInfo", usp)
        .then(res => {
          ...
          if (this.mm != "") {
            axios //标准
              .get(
                "http://125.89.236.222:8006/api/getControlStandardProduction",
                {
                  params: {
              ...
              .then(res => {
               ...
               this.biaozhunzhi = res.data.data[0];
                ...
                axios
                  .get(
                    "http://125.89.236.222:8006/api/getProcessExecutionInfo",
                    {
                      params: {
                        limit: "all",
                  ...
                  .then(res => {
                    ...
                    var obj1 = {
                      additionalTrafficBottoming: this.biaozhunzhi.additionalFlowRateIStandardBRD, //靛蓝前母液追加流量
                      additionalTrafficIndigo: this.biaozhunzhi.additionalFlowRateIStandard, //靛蓝母液追加流量
                      additionalTrafficSurface: this.biaozhunzhi.additionalFlowRateIStandardBCD, //靛蓝后母液追加流量
                      boardName: "A", //生产线名称
                ...
                axios
                  ...
                  .then(res => {
                    ...
                    var obj3 = {
                      ...
                      steam: Number(this.biaozhunzhi.electricityInformationM)/10000, 
