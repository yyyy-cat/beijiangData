      ...
      <div class="protab-sc_bg1">
        ...
        <div class="protab-sc_bg1-box">
          <el-table :data="tableData" border style="width: 100%;">
            <el-table-column prop="lineID" label="机台号" align="center" width="300"></el-table-column>
            ...
            <el-table-column prop="varieties" label="品种" align="center" width="500"></el-table-column>
            <el-table-column prop="warpingLength" label="整经长度" align="center" width="450"></el-table-column>
            <el-table-column prop="startTime" label="开机时间" align="center" width="550"></el-table-column>
            <el-table-column prop="endTime" label="预计了机时间" align="center" width="540"></el-table-column>
          </el-table>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    setShui() {
      //水能耗
      axios
        .get("http://125.89.236.222:8005/api/getEnergyConsumptionChart", {
          params: {
            type: 2
          }
        })
    ...
    setData() {
      axios
        .get("http://125.89.236.222:8005/getRunningBasicInfo", {
          params: {
            lineID: "all"
          }
        })
    ...
    drawLine() {
      ...
      axios
        ...
        .then(res => {
          ...
          // 水
          let bar1 = this.$echarts.init(
            document.getElementById("myChart-bar1")
          );
      ...
      bar3.setOption({
        ...
        series: [
          ...
          },
          {
            ...
            data: [300, 310, 287, 300, 370, 310, 330, 323, 300, 350]
          }
        ]
      });
      // // 机台车速
