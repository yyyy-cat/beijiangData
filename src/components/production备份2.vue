  ...
  <div class="production">
    ...
    <div v-show="cur==0" class="production-shuju">
      ...
      <div class="mother-shuju">
        ...
        <div class="mother-shuju-one">
          <p>能耗信息（水）</p>
          <div class="mother-shuju-table1" style="background: rgba(255, 255, 255, 15%);">
            <el-table
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table1">
            ...
            >
              ...
              <el-table-column label="实时上染率（%）" align="center" width="1900">
                <el-table-column prop="zjDosageBCD" label="渗透剂用量（kg/万米）" align="center" width="480"></el-table-column>
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table1" style="background: rgba(255, 255, 255, 15%);">
            <el-table
              ...
              style="width: 100%;"
            >
              <el-table-column prop="type" label="采集点" align="center" width="430"></el-table-column>
              <el-table-column prop="time" label="采集时间" align="center" width="270"></el-table-column>
              <el-table-column
      ...
      <div class="mother-shuju">
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table2">
            <el-table
              ...
              style="width: 100%;"
            >
              <el-table-column prop="type" label="采集时间" align="center" width="560"></el-table-column>
              <el-table-column prop="time" label="用水信息（吨）" align="center" width="600"></el-table-column>
              <el-table-column prop="ph" label="用水信息（吨/万米）" align="center" width="740"></el-table-column>
            </el-table>
          </div>
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table1">
            ...
            >
              <el-table-column prop="type" label="采集时间" align="center" width="560"></el-table-column>
              <el-table-column prop="time" label="用电信息（吨）" align="center" width="600"></el-table-column>
              <el-table-column prop="ph" label="用电信息（吨/万米）" align="center" width="740"></el-table-column>
            </el-table>
          </div>
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table2">
            <el-table
              :data="tableDataBB5.slice((currentPageBB5-1)*pagesize,currentPageBB5*pagesize)"
              border
              style="width: 100%;"
            >
              <el-table-column prop="type" label="采集点" align="center" width="430"></el-table-column>
          ...
          <div class="mother-shuju-two">
            <div class="mother-shuju-three2">
              <el-pagination
                :page-size="pagesize"
                :current-page.sync="currentPageBB5"
                background
                layout="jumper , prev, pager, next"
                :total="totalBB5"
              ></el-pagination>
    ...
    <div v-show="cur==2" class="production-shuju">
      ...
      <div class="mother-shuju">
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table2">
            <el-table
              :data="tableDataCC5.slice((currentPageCC5-1)*pagesize,currentPageCC5*pagesize)"
              border
              style="width: 100%;"
            >
              <el-table-column prop="type" label="采集点" align="center" width="430"></el-table-column>
          ...
          <div class="mother-shuju-two">
            <div class="mother-shuju-three2">
              <el-pagination
                :page-size="pagesize"
                :current-page.sync="currentPageCC5"
                background
                layout="jumper , prev, pager, next"
                :total="totalCC5"
              ></el-pagination>
    ...
    <div v-show="cur==3" class="production-shuju">
      ...
      <div class="mother-shuju">
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-table2">
            <el-table
              :data="tableDataDD5.slice((currentPageDD5-1)*pagesize,currentPageDD5*pagesize)"
              border
              style="width: 100%;"
            >
              <el-table-column prop="type" label="采集点" align="center" width="430"></el-table-column>
          ...
          <div class="mother-shuju-two">
            <div class="mother-shuju-three2">
              <el-pagination
                :page-size="pagesize"
                :current-page.sync="currentPageDD5"
                background
                layout="jumper , prev, pager, next"
                :total="totalDD5"
              ></el-pagination>
      ...
      <div class="mother-shuju">
        ...
        <div class="mother-shuju-one">
          ...
          <div class="mother-shuju-one">
            ...
            <div class="mother-shuju-table2">
              <el-table
                :data="tableDataEE5.slice((currentPageEE5-1)*pagesize,currentPageEE5*pagesize)"
                border
                style="width: 100%;"
              >
                <el-table-column prop="type" label="采集点" align="center" width="430"></el-table-column>
            ...
            <div class="mother-shuju-two">
              <div class="mother-shuju-three2">
                <el-pagination
                  :page-size="pagesize"
                  :current-page.sync="currentPageEE5"
                  background
                  layout="jumper , prev, pager, next"
                  :total="totalEE5"
                ></el-pagination>
...
export default {
  ...
  methods: {
    ...
    //   usp.append("lineID", "A");
    //   usp.append("type", 4);
    //   usp.append("cylinderNo", this.mA.cylinderNo);
    //   console.log(this.mA);

    //   axios
    //     .post("http:// 125.89.236.222:8005/api/getProcessExecutionInfo", usp)
    //     .then(res => {
