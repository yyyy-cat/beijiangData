...
export default {
  ...
  methods: {
    ...
    // setbiaozhunA() {
    //   axios
    //     .get("http://192.168.10.32:8005/api/getProcessExecutionInfo", {
    //       params: {
    //         limit: "all",
    ...
    AA2() {
      axios
        .get("http://192.168.10.32:8005/api/getEnergyConsumption", {
          params: {
            limit: this.pagesize,
    ...
    AA4() {
      axios
        .get("http://192.168.10.32:8005/api/getDosageOfExcipients", {
          params: {
            limit: "all",
